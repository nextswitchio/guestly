  ...
  if (!product) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-neutral-50 text-center">
        <span className="text-5xl"><Frown className="h-4 w-4 inline-block" /></span>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mx-auto grid max-w-4xl gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-2 text-base font-bold text-dark tabular-nums">${product.price}</p>
