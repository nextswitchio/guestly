...
const quickActions = [
  { label: "Create Event", href: "/dashboard/events/new", iconName: "plus" as const, color: "bg-lime text-dark font-bold hover:bg-lime-hover" },
  { label: "View Events", href: "/dashboard/events", iconName: "calendar" as const, color: "bg-white text-neutral-700 border border-neutral-200 hover:bg-neutral-50" },
  { label: "Analytics", href: "/dashboard/analytics", iconName: "chart" as const, color: "bg-white text-neutral-700 border border-neutral-200 hover:bg-neutral-50" },
  { label: "Wallet", href: "/dashboard/wallet", iconName: "wallet" as const, color: "bg-white text-neutral-700 border border-neutral-200 hover:bg-neutral-50" },
];
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="rounded-2xl border border-neutral-200 bg-white p-5 lg:col-span-2">
              <div className="mb-6 flex items-center justify-between">
                ...
                <Link href="/dashboard/events" className="inline-flex items-center gap-1 text-sm font-semibold text-lime-600 hover:text-lime-700 transition-colors">
