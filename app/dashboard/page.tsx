...
const quickActions = [
  ...
  { label: "View Events", href: "/dashboard/events", icon: "📋" },
    ...
    <ProtectedRoute allowRoles={["organiser"]}>
      <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {quickActions.map((a) => (
              <Link
                key={a.label}
                href={a.href}
                className="flex flex-col items-center gap-2 rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-center transition hover:border-primary-300 hover:bg-primary-50"
              >
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <Card>
            <h2 className="mb-3 text-sm font-semibold text-neutral-900">Revenue Overview</h2>
            <div className="flex h-40 items-center justify-center rounded-xl border border-dashed border-neutral-200 bg-neutral-50">
              <p className="text-xs text-neutral-400">Revenue chart coming soon</p>
            </div>
          </Card>
          <Card>
            <h2 className="mb-3 text-sm font-semibold text-neutral-900">Ticket Sales</h2>
            <div className="flex h-40 items-center justify-center rounded-xl border border-dashed border-neutral-200 bg-neutral-50">
              <p className="text-xs text-neutral-400">Sales chart coming soon</p>
            </div>
          </Card>
        </div>
      </div>
