      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="rounded-2xl bg-gradient-to-r from-neutral-900 to-neutral-700 p-6 text-white shadow-lg">
          ...
          <div className="mt-6 flex gap-3">
            <Button href="/dashboard/wallet/add" variant="primary" className="flex items-center gap-2">
        ...
        {!loading && transactions.length > 0 && (
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/dashboard/wallet/history" className="text-sm font-semibold text-lime hover:text-lime-hover flex items-center gap-1">
