      ...
      <section className="relative overflow-hidden py-24 lg:py-32">
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          <div className="flex flex-col items-center max-w-4xl mx-auto">
            ...
            >
              <Button href="/register?role=organizer" size="xl" glow className="min-w-[200px]">
                Create Your Event
              </Button>
              <Button href="/login?role=organizer" variant="outline" size="xl" className="min-w-[200px] border-[var(--surface-border)] bg-[var(--surface-card)] text-[var(--foreground)] hover:bg-[var(--surface-hover)] dark:bg-white/5 dark:hover:bg-white/10">
                Sign In
              </Button>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              ...
              <div className="pt-6">
                <Button href="/register?role=organizer" size="xl" glow>
