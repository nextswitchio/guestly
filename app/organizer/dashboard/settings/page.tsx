                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" value={city} onChange={e => setCity(e.target.value)}
                        className="w-full h-11 rounded-xl border border-neutral-200 bg-neutral-50 px-4 text-sm focus:outline-none focus:border-lime focus:ring-2 focus:ring-lime/20" />
                    </div>
                    <div>
