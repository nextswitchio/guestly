    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3 space-y-1">
          <p className="px-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-navy-500">Vendor</p>
          {mainLinks.map((link) => <NavItem key={link.href} link={link} />)}
          {!collapsed && <div className="pt-3"><p className="px-3 pb-1 text-[10px] font-bold uppercase tracking-widest text-navy-500">Settings</p></div>}
