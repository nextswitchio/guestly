...
const icons: Record<IconName, (props: React.SVGProps<SVGSVGElement>) => React.JSX.Element> = {
  ...
  truck: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0ZM19.5 18.75a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0ZM2.25 15h16.125m-16.125 0v-4.875A2.25 2.25 0 0 1 4.5 7.875h9.375c.621 0 1.125.504 1.125 1.125V15m-10.5 0h10.5m4.305-3V8.835a2.25 2.25 0 0 0-.512-1.442l-2.91-3.41A2.25 2.25 0 0 0 12.323 3.375H10.5" />
    </svg>
  ),
  "bar-chart": (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  activity: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12h3.375a1.125 1.125 0 0 1 1.125 1.125v3.375M2.25 12H5.25m-.375 0 4.438-4.438a1.125 1.125 0 0 1 1.591 0L14.25 12m0 0 4.438-4.438a1.125 1.125 0 0 1 1.591 0L21.75 12m-9.469 1.969V19.5a1.125 1.125 0 0 1-1.125 1.125H6.75a1.125 1.125 0 0 1-1.125-1.125v-3.375a1.125 1.125 0 0 1 1.125-1.125h3.375a1.125 1.125 0 0 1 1.125 1.125Z" />
    </svg>
  ),
  eye: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  cpu: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5m-15 7.5H3m18 0h-1.5m-15 4.5V21m3.75-18v1.5m7.5-1.5V4.5m3.75 12V21m-12-15h7.5A1.5 1.5 0 0 1 21 7.5v7.5a1.5 1.5 0 0 1-1.5 1.5h-7.5A1.5 1.5 0 0 1 9 15v-7.5A1.5 1.5 0 0 1 10.5 6ZM9 15l-1.5 1.5M15 9l1.5-1.5M9 9l-1.5-1.5M15 15l1.5 1.5" />
    </svg>
  ),
  monitor: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  percent: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5 19.5 4.5m-15 0h.008v.008H4.5V4.5Zm15 15h.008v.008h-.008V19.5Z" />
    </svg>
  ),
  "share-2": (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  "user-check": (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="m16.5 13.5 2.25 2.25 4.5-4.5" />
    </svg>
  ),
  "toggle-left": (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5A4.5 4.5 0 0 1 11.25 3h1.5a4.5 4.5 0 0 1 0 9h-1.5a4.5 4.5 0 0 1-4.5-4.5ZM6.75 16.5A4.5 4.5 0 0 0 11.25 21h1.5a4.5 4.5 0 0 0 0-9h-1.5a4.5 4.5 0 0 0-4.5 4.5Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z" />
    </svg>
  ),
  "pause-circle": (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  key: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.973m-2.477 2.477A5.98 5.98 0 0 1 5.5 15m11.096-9.363-2.3 2.3a2.996 2.996 0 0 1-2.841.566m4.141-4.141L19.75 7.75" />
    </svg>
  ),
  save: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12" />
    </svg>
  ),
  store: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  webhook: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 9.75l4.5 4.5m0-5.25a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm9 9a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
  ),
  power: (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
