        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card className="p-4">
              <div className="flex items-center justify-between">
                ...
                <Icon name="megaphone" className="w-8 h-8 text-lime" />
              </div>
            </Card>
            <Card className="p-4">
              <div className="flex items-center justify-between">
                ...
                <Icon name="play" className="w-8 h-8 text-green-500" />
              </div>
            </Card>
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1 text-amber-500">{stats.scheduled}</p>
                </div>
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1 text-neutral-500">{stats.completed}</p>
                </div>
                <Icon name="check-circle" className="w-8 h-8 text-neutral-500" />
              </div>
            </Card>
        </div>
          ...
          <div className="space-y-4">
            {filteredCampaigns.length === 0 ? (
              <Card className="p-12 text-center">
                <Icon name="megaphone" className="w-16 h-16 mx-auto text-neutral-400 mb-4" />
